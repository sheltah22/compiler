...
(* OASIS_START *)
(* DO NOT EDIT (digest: 34790b2a6d6b0b0aa9bbf42df16ead9c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "opam"];
               ...
               Test
                 ({
                     cs_name = "test-lets-and-fun-parse";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Test
                 ({
                     cs_name = "test-multi-params-parse";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Test
                 ({
                     cs_name = "test-fix-multi-params-parse";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_digest = Some "\224dw\014\241\224'\014X\224Ub\228\197t\026";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
