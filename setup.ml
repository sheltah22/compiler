...
(* OASIS_START *)
(* DO NOT EDIT (digest: adaba09f72b601e7ada7b754fc796745) *)
(*
...
let setup_t =
  {
     ...
     oasis_digest = Some "\006B\159Rs\165ak\174\022lE?8u\178";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
